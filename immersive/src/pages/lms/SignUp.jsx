...
function SignUp() {
    ...
    // a function to validate age , t be atleast 10
    ...
    const handleSubmit = async (e) => {
        ...
        if(!isValidBirthDate(birthDate)){
            setError("Birth date is not valid");
            return;
        }
        try {
            let formData = {
                                ...
                                <div className="container d-flex justify-content-center align-items-center min-vh-100">
                                    <div className="card p-2 p-md-4 shadow-lg" style={{ width: "100%", maxWidth: "400px" }}>
                                        <form onSubmit={handleSubmit} className="sign-up-form row">
                                            ...
                                            <div className="mb-3 col-12 col-md-5 col-lg-6 fs-6">
                                                <select name="country" id="country"  className='form-select' onChange={(e) => setCountry(e.target.value)} placeholder="Country" required>
                                            ...
                                            <div className="mb-3 col-12 col-md-5 col-lg-6 fs-6">
                                                <select name="continent" id="continent"  className='form-select'  onChange={(e) => setContinent(e.target.value)} placeholder="Continent" required >
                                            ...
                                            <button type="submit" className="btn btn-primary fw-bolder btn-block text-white">Create Account</button>
                                        </form>
    ...
    {/* Carousel Controls */}
    <div className="carousel-controls mt-5" style={{ bottom: "0px" }}>
    ...
    <style jsx>{`
        .carousel-item {
          min-height: 500px; /* Adjust height to keep items consistent */
        ...
        /* Centering the controls vertically */
        ...
        /* Styling for the control icons */
        .carousel-control-prev-icon,
        .carousel-control-next-icon {
          background-color: rgba(0, 0, 0, 0.5); /* Add a background color to icons */
          border-radius: 50%;
          width: 30px;
          height: 30px;
        }
