...
class Student {
    ...
    static async suspendStudent(idStudent) {
      try {
        const suspensionEnd = new Date();
        suspensionEnd.setDate(suspensionEnd.getDate() + 30); // 30 days from now
        ...
        const values = [suspensionEnd, idStudent];
        ...
        const notification = new Notification(
          ...
          "student",
          updatedStudent.rows[0].idStudent
        );
        ...
        throw new Error("Error suspending student");
      }
    }
